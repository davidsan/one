...
public class DTNHost implements Comparable<DTNHost> {
	 ...
	 * 
	 * @return know accidents set
	 */
	public Set<MapNode> getKnownAccidents() {
		return knownAccidents;
	}

	/**
	 * Getter for the known locations map
	 * 
	 * @return the known locations map
	 */
	public Map<DTNHost, Tuple<Coord, Integer>> getKnownLocations() {
	 ...
	 *            freshness value
	 */
	public void updateKnownLocations(DTNHost host, Coord c, Integer stamp) {
		Tuple<Coord, Integer> val = knownLocations.get(host);
		if (val == null || val.getValue() < stamp) {
			// System.err.println("[debug] host " + getAddress()
			// + " update his host " + host.getAddress() + " location");
			// if (val != null)
			// System.err.println("Previous known location of the host "
			// + host.getAddress() + " : " + val.getKey()
			// + " (stamp : " + val.getValue() + ")");
			// System.err.println("New known location of the host "
			// + host.getAddress() + "  : " + c + " (stamp : " + stamp
			// + ")");
			knownLocations.put(host,
					new Tuple<Coord, Integer>(c.clone(), stamp));
		}
	}
	 ...
	 */
	public void updateSelfKnownLocation() {
		knownLocations.put(this,
				new Tuple<Coord, Integer>(this.location.clone(), stamp++));
	}
	 ...
	 * 
	 * @return recalculatingRoute boolean
	 */
