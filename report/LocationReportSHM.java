...
/**
 * Location report stored in an on-memory database (/dev/shm)
 * 
 * @author Virginie Collombon, David San
 */
public class LocationReportSHM extends ReportRAM implements UpdateListener {
